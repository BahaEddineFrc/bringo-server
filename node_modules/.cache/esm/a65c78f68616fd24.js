_861‍.x([["getAllRestaurants",()=>getAllRestaurants],["getRestauById",()=>getRestauById],["getCategoryById",()=>getCategoryById],["getDishById",()=>getDishById],["createRestau",()=>createRestau],["getAllCategories",()=>getAllCategories],["createCategory",()=>createCategory],["deleteCategory",()=>deleteCategory],["getAllDishes",()=>getAllDishes],["createDish",()=>createDish],["deleteDish",()=>deleteDish],["deleteRestau",()=>deleteRestau]]);const express = require('express');
...
//DONE
  ...
  try {
    Restaurant.findOne({ _id: req.params.id }, function(error, restaurant) {
      ...
      for (let m of restaurant.menu) {
          m.populate('cat').execPopulate();
        for (let cat of m.sectionCategories) { 

          console.log(" cat : "+ cat)

          Category.findOne({ _id: cat.cat }, function(error, category) {
            //cat=category
          //await cat.populate('cat').execPopulate();
          })
